...
if(typeof MudiExperience == "undefined"){
    ...
    setTimeout(()=>{
        mudiExperience.experienceOn( document.body.querySelector('.product-title_product-title__specification__UTjNc').innerText.replace('RTA-PLU: ','') , document.body.querySelector('.swiper'));
    },3000)
